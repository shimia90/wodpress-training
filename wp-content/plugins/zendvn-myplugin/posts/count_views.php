...
class Zendvn_Mp_Count_Views{
	...
	public function set_post_views(){
		...
		$count_key = 'zendvn_post_views_count';
	...
	public function add_css_file(){
		wp_register_style('zendvn_mp_post_cols', ZENDVN_MP_CSS_URL . '/post_cols.css', array(),'1.0');
		wp_enqueue_style('zendvn_mp_post_cols');
	}
