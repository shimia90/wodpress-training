	...
	<div id="footer-widgets" class="clr">
		<div class="footer-box span_1_of_4 col col-1">
			<div class="footer-widget widget_text clr">
				...
				<div class="textwidget">Live the life of luxury and share it with
					your readers using Spartan. This clean and beautiful theme is
					perfect for bloggers, photographers, magazines and more. Just take
					a look at a few of the wonderful features included in this premium
					theme – we’re sure you’ll love them!</div>
			</div>
		</div>
		<!-- .footer-box -->
			...
			<div class="footer-widget widget_wpex_recent_news_widget clr">
				...
				<ul class="widget-latest-news clr">
					<li class="first-post clr">
						...
						class="widget-recent-posts-title">I&#8217;m Hungry, Make Me A
							Sandwich</a>
					...
					<li><a href="#" title="Best Places To Buy Music">Best Places To Buy
							Music</a></li>
					<li><a href="#" title="Speeding Down The Formula 1 Track">Speeding
							Down The Formula 1 Track</a></li>
				...
				<ul class="widget-recent-posts clr">
					<li class="clr widget-recent-posts-li top-thumbnail format-gallery">
						...
						<div class="widget-recent-posts-content clr">
							<a href="#"
								title="Formula 1 Is Boring But The Cars Are Super Awesome"
								class="widget-recent-posts-title">Formula 1 Is Boring But The
								Cars Are Super Awesome</a>
					...
					<li class="clr widget-recent-posts-li top-thumbnail format-gallery">
						...
						<div class="widget-recent-posts-content clr">
							<a href="#" title="Model Shoot For GQ 2015"
								class="widget-recent-posts-title">Model Shoot For GQ 2015</a>
						</div> <!-- .widget-recent-posts-content -->
					</li>
					<li class="clr widget-recent-posts-li top-thumbnail format-gallery">
						...
						<div class="widget-recent-posts-content clr">
							<a href="#" title="Amazing Nature Photography by Matt Tucker"
								class="widget-recent-posts-title">Amazing Nature Photography by
								Matt Tucker</a>
						</div> <!-- .widget-recent-posts-content -->
					</li>
				</ul>
		...
		<div class="footer-box span_1_of_4 col col-4">
			<div class="footer-widget widget_wpex_social_widget clr">
				...
				<div class="social-widget-description clr">Feel like getting on
					touch or staying upto date with out latest news and updates?</div>
				...
				<ul class="clr color flat">
					...
					<li class="google-plus"><a href="#" title="Google+" target="_blank">
							<span class="fa fa-google-plus"></span>
					</a></li>
					<li class="rss"><a href="#" title="RSS" target="_blank"> <span
